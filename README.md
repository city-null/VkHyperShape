...
VkHyperShape 专注于解决**四维空间到三维空间的投影与渲染**问题。它通过自定义的 4D 数学库与 Vulkan 高性能渲染管线，将抽象的高维几何结构直观地呈现在屏幕上。
...
- **通用几何支持**：不仅限于超立方体，支持多种正多胞形（Polytope）。
...
### 4D 投影管线
本项目采用经典的**齐次坐标**体系，将维度从 3D 扩展到 4D：